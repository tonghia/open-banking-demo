...
public class CreditInterest1TierBand {
  ...
  /**
   * How often is interest applied to the PCA for this tier/band i.e. how often
   * the financial institution pays accumulated interest to the customer's PCA.
   */
   ...
   * describe the annual interest rate payable to the PCA.
   */
  ...
  public CreditInterest1TierBand depositInterestAppliedCoverage(
  ...
  public CreditInterest1TierBand fixedVariableInterestRateType(

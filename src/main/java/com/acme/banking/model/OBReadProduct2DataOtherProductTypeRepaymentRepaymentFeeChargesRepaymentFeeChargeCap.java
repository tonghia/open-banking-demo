...
/**
 * RepaymentFeeChargeCap sets daily, weekly, monthly, yearly limits on the fees
 * that are charged
 */
...
public class OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap {
  ...
  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap feeType(
      List<FeeTypeEnum> feeType) {
    this.feeType = feeType;
    return this;
  }

  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap addFeeTypeItem(
      FeeTypeEnum feeTypeItem) {
  ...
  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap minMaxType(
  ...
  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap feeCapOccurrence(
      Integer feeCapOccurrence) {
  ...
  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap feeCapAmount(
      String feeCapAmount) {
  ...
  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap cappingPeriod(
      OBPeriod1Code cappingPeriod) {
  ...
  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap addNotesItem(
      String notesItem) {
    if (this.notes == null) {
  ...
  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap otherFeeType(
      List<OBReadProduct2DataOtherProductTypeOverdraftOtherFeeType> otherFeeType) {
    this.otherFeeType = otherFeeType;
    return this;
  }

  public OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap addOtherFeeTypeItem(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.feeType,
        obReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap.feeType)
        && Objects.equals(this.minMaxType,
            obReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap.minMaxType)
        && Objects.equals(this.feeCapOccurrence,
            obReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap.feeCapOccurrence)
        && Objects.equals(this.feeCapAmount,
            obReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap.feeCapAmount)
        && Objects.equals(this.cappingPeriod,
            obReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap.cappingPeriod)
        && Objects.equals(this.notes,
            obReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap.notes)
        && Objects.equals(this.otherFeeType,
            obReadProduct2DataOtherProductTypeRepaymentRepaymentFeeChargesRepaymentFeeChargeCap.otherFeeType);
  }
